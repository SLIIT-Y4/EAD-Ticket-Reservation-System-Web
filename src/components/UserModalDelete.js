  ...
  return (
    <Modal {...props} size="" aria-labelledby="contained-modal-title-vcenter" centered>
      ...
      <Modal.Header closeButton>
        <Modal.Title>{props.type == 'delete' ? 'Delete Account' : 'Logout'}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {props.type == 'delete' ? 'Are you sure you want to delete your account permanetly ?' : 'Do you want to logout'}
      </Modal.Body>
      <Modal.Footer>
