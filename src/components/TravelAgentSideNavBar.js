...
import { travelAgentSideNavbarData } from './SideNavBarData';
import './NavBar.css';
      ...
      <IconContext.Provider value={{ color: '#fff' }}>
        ...
        <nav className={'nav-menu active'}>
          <ul className="nav-menu-items">
            ...
            {travelAgentSideNavbarData.map((item, index) => {
              return (
...
export default TravelAgentSideNavBar;
